        ...
        return (
            ...
            <div class="cover bg-left bg-center-l">
              <div class="bg-black-80 pb5 pb6-m pb7-l">
                <nav class="dt w-100 mw8 center"> 
                  <div class="dtc w2 v-mid pa3">
                    <a href="/" class="dib w2 h2 pa1 ba b--white-90 grow-large border-box">
                      <svg class="link white-90 hover-white" data-icon="bitcoin" viewBox="0 0 32 32" ><path d="M16 0 C6 0 2 4 2 14 L2 22 L6 24 L6 30 L26 30 L26 24 L30 22 L30 14 C30 4 26 0 16 0 M9 12 A4.5 4.5 0 0 1 9 21 A4.5 4.5 0 0 1 9 12 M23 12 A4.5 4.5 0 0 1 23 21 A4.5 4.5 0 0 1 23 12"></path></svg>
                    </a>
                  </div>
                ...
                <a class="f6 no-underline grow dib v-mid white ba b--white ph3 pv2 mb3" href="/">Subscribe to upcomming pools</a>
                </div>
              </div>
            </div> 
          </header>
